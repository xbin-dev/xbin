...
func routeTable() []routeDef {
	return []routeDef{
		...
		{"GET /runs/{id}/members", needViewer, handleMembers},
		{"POST /runs/{id}/members", needOwner, handleAddMember},
		{"DELETE /runs/{id}/members/{user}", needViewer, handleRemoveMember},
		{"POST /runs/{id}/links", needOwner, handleNewLink},
		{"DELETE /runs/{id}/links/{lid}", needOwner, handleRevokeLink},
		{"POST /join", needUser, handleJoin},
		{"GET /automations", needAny, handleAutomations},
		{"GET /automations/{kind}/{aid}", needAny, handleAutomation},
